...
if __name__ == "__main__":
    for i in range(get_total_frames("test2-processed.mp4")):
        # 提取视频中的某一帧（例如第10帧）及其时间戳
        frame_image, timestamp = extract_frame('test2-processed.mp4', i)

        # 对该帧进行二值化处理并保存
        binary_image = image_thresholding(frame_image, timestamp=timestamp)
